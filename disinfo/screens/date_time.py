...
s_day_box = {
    'weekend': DivStyle(radius=1, border=1, border_color=amber_red.darken(.1).hex, padding=[1, 0, 1, 1]),
    'weekday': DivStyle(radius=1, border=1, border_color=gray.hex, padding=[1, 0, 1, 1]),
}
s_colon = [
